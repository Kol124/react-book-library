...
import { addBook, selectBook } from "../features/library/librarySlice";
  ...
  return (
    <Card>
      ...
      <div>
        ...
        <Buttons>
          <button disabled={addBookDisabled} onClick={add}>
            Add to Library
          </button>
    ...
    // <Card>
    //   <img src="/images/book-03" alt="the hound of the baskervilles" />
    // </Card>
  );
};
